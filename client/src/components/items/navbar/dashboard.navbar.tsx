...
import Dashhome from '../feat/dashboard.home.feat'
...
const navigation = [
  { name: 'Forfait', href: '#', current: true },
      ...
      <div className="min-h-full">
        ...
        <header className="bg-white shadow">
          <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
            <h1 className="text-3xl font-bold text-gray-900">Bienvenue, Diego.</h1>
          </div>
        </header>
        <main>
